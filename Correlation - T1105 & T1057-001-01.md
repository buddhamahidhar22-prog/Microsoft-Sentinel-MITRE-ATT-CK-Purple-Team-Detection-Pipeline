...
![Analytics rule configured](analytics%20rule%20in%20place.png)

### Attacker Execution

Remote execution from the attacker VM:

![Attacker execution](Attacker%20execution.png)

### Sysmon Confirmation

Host-level confirmation of the relevant Sysmon events:

![Sysmon confirmation](Sysmon%20confirmation%20on%20victim%20vm.png)

### Sentinel Correlation Incident

The resulting Sentinel incident showing the correlated behavioral sequence:

![Sentinel correlation incident](correlation%20incident.png)
